...
class MagicEraserSettingsChangedMail extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        $subject = $this->isReset
            ? 'Magic Eraser Settings Reset — ' . config('app.name')
            : 'Magic Eraser Settings Changed — ' . config('app.name');
    ...
    {
        return new Content(
            view: 'emails.admin.magic-eraser-settings-changed',
        );
    }
}
