...
class BackgroundRemoverSettingsChangedMail extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        $subject = $this->isReset
            ? 'Background Remover Settings Reset — ' . config('app.name')
            : 'Background Remover Settings Changed — ' . config('app.name');
    ...
    {
        return new Content(
            view: 'emails.admin.background-remover-settings-changed',
        );
    }
}
