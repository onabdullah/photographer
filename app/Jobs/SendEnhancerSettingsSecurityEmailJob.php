...
use App\Mail\Admin\EnhancerSettingsChangedMail;
...
class SendEnhancerSettingsSecurityEmailJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        foreach ($superAdmins as $superAdmin) {
            Mail::to($superAdmin->email)->send(
                new EnhancerSettingsChangedMail($admin, $this->changes, $this->isReset)
            );
        }
    }
}
