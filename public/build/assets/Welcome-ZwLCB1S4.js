 88.69 205.635L88.7 205.645C88.82 205.765 88.98 205.855 89.12 205.965C89.28 206.085 89.42 206.225 89.59 206.325C89.6 206.325 89.6 206.325 89.61 206.335C89.62 206.335 89.62 206.345 89.63 206.345L139.87 234.775V285.065L43.67 229.705V60.135ZM244.75 229.705L148.58 285.075V234.775L219.8 194.115L244.75 179.875V229.705ZM297.2 139.625L253.49 164.795V114.995L278.85 100.395L297.21 89.825V139.625H297.2Z"/></svg>',L=`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    nav {
        ...
        padding: 0 56px;
        background: linear-gradient(120deg, rgba(255,255,255,.58), rgba(255,255,255,.36));
        backdrop-filter: blur(22px) saturate(165%);
        -webkit-backdrop-filter: blur(22px) saturate(165%);
        border-bottom: 1px solid rgba(255,255,255,.55);
        box-shadow: 0 8px 30px rgba(20,60,72,.12);
        z-index: 100;
    ...
    .logo-mark {
        ...
        border: 1px solid rgba(70,138,154,.3);
        padding: 4px;
        flex-shrink: 0;
    ...
    .tool-item.ai-shoot-featured {
        grid-template-columns: 72px 1fr;
        background: linear-gradient(135deg, rgba(70,138,154,.12), rgba(255,122,48,.08));
        border-left: 4px solid var(--teal);
    }
    .tool-item.ai-shoot-featured:hover {
        background: linear-gradient(135deg, rgba(70,138,154,.18), rgba(255,122,48,.12));
    }
    .tool-item.ai-shoot-featured .tool-num {
        font-size: 1.08rem;
        color: var(--teal-dark);
        padding-left: 20px;
        padding-top: 34px;
    }
    .tool-item.ai-shoot-featured .tool-body {
        padding: 30px 32px 30px 24px;
    }
    .tool-item.ai-shoot-featured .tool-name {
        font-size: 1.55rem;
        display: flex;
        align-items: center;
        gap: 10px;
    }
    .tool-item.ai-shoot-featured .tool-desc {
        font-size: .92rem;
        margin-top: 10px;
        color: var(--ink-2);
        max-width: 760px;
    ...
    .ai-mini-card {
        border: 1px solid rgba(70,138,154,.24);
    ...
    .ai-mini-card:nth-child(2) {
        animation-delay: .3s;
    }
    .ai-mini-card:nth-child(3) {
        animation-delay: .6s;
    }
    .ai-mini-k {
        font-size: .62rem;
    ...
    @media (max-width: 1024px) {
        ...
        .ai-shoot-mini-grid { grid-template-columns: 1fr 1fr; }
    ...
    @media (max-width: 768px) {
        ...
        .tool-item.ai-shoot-featured { grid-template-columns: 60px 1fr; }
        .tool-item.ai-shoot-featured .tool-name { font-size: 1.35rem; }
        .ai-shoot-mini-grid { grid-template-columns: 1fr; }
...
<section class="numbers-section sr">
    <div class="container">
        <div class="numbers-grid" id="numGrid">
            ...
            <div class="nitem">
                <div class="big" data-target="7" data-suffix="">7</div>
    ...
    <div class="container">
        ...
        <div class="tools-layout">
            ...
            <div class="tools-list sfr" id="toolsList">
                ...
                <div class="tool-item ai-shoot-featured">
                    <div class="tool-num">07</div>
                    <div class="tool-body">
                        <div class="tool-name">AI Shoot <span class="ai-shoot-badge">Main Tool</span></div>
                        <p class="tool-desc">Use world-class generative AI models to create new product visuals from your store images, your own custom uploads, or text prompts. Includes 100 ready virtual try-on models, and you can also build your own custom model.</p>
                        <div class="ai-shoot-mini-grid">
                            <div class="ai-mini-card">
                                <span class="ai-mini-k">Generation</span>
                                <span class="ai-mini-v">From store images, custom uploads, or prompts</span>
                            </div>
                            <div class="ai-mini-card">
                                <span class="ai-mini-k">Virtual Try-On</span>
                                <span class="ai-mini-v">100 ready models for fast campaign concepts</span>
                            </div>
                            <div class="ai-mini-card">
                                <span class="ai-mini-k">Custom Model</span>
                                <span class="ai-mini-v">Create your own model style to match your brand</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="gen-layout">
            <div class="gen-copy sl">
                ...
                <div class="gen-feats">
                    <div class="gen-feat"><span class="gen-feat-dot"></span> Virtual Try-On with 100 ready models plus custom model support</div>
...
`;function P(){return S.useEffect(()=>{const l=document.getElementById("bar"),d=document.getElementById("nav"),c=document.querySelector(".hero-right"),p=document.getElementById("toolsList"),g=document.getElementById("numGrid"),v=()=>{if(!l)return;const e=window.scrollY/(document.body.scrollHeight-window.innerHeight)*100;l.style.width=`${e}%`},m=()=>{d&&(d.style.boxShadow=window.scrollY>40?"0 1px 24px rgba(70,138,154,.08)":"none")},f=()=>{c&&window.scrollY<window.innerHeight&&(c.style.transform=`translateY(${window.scrollY*.06}px)`)};window.addEventListener("scroll",v,{passive:!0}),window.addEventListener("scroll",m,{passive:!0}),window.addEventListener("scroll",f,{passive:!0});const n=new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting&&(t.target.classList.add("in"),n.unobserve(t.target))})},{threshold:.1});document.querySelectorAll(".sr, .sl, .sfr").forEach(e=>n.observe(e));let o=null;p&&(o=new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting&&t.target.querySelectorAll(".tool-item").forEach((a,s)=>{a.style.opacity="0",a.style.transform="translateX(20px)",setTimeout(()=>{a.style.transition="opacity .6s ease, transform .6s ease",a.style.opacity="1",a.style.transform="translateX(0)"},s*80)})})},{threshold:.05}),o.observe(p));const w=(e,t,a)=>{let s=null;const h=u=>{s||(s=u);const x=Math.min((u-s)/1400,1),k=1-(1-x)**3;e.textContent=`${Math.floor(k*t)}${a}`,x<1&&requestAnimationFrame(h)};requestAnimationFrame(h)};let r=null;return g&&(r=new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting&&t.target.querySelectorAll("[data-target]").forEach(a=>{w(a,Number(a.dataset.target),a.dataset.suffix||"")})})},{threshold:.4}),r.observe(g)),()=>{window.removeEventListener("scroll",v),window.removeEventListener("scroll",m),window.removeEventListener("scroll",f),n.disconnect(),o&&o.disconnect(),r&&r.disconnect()}},[]),i.jsxs(i.Fragment,{children:[i.jsxs(z,{title:"PixelForge AI - Product Photography for Shopify",children:[i.jsx("meta",{charSet:"UTF-8"}),i.jsx("meta",{name:"viewport",content:"width=device-width, initial-scale=1.0"}),i.jsx("link",{rel:"preconnect",href:"https://fonts.googleapis.com"}),i.jsx("link",{rel:"preconnect",href:"https://fonts.gstatic.com",crossOrigin:"anonymous"}),i.jsx("link",{href:"https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@300;400;500;600&family=Figtree:wght@300;400;500;600&display=swap",rel:"stylesheet"})]}),i.jsx("style",{dangerouslySetInnerHTML:{__html:L}}),i.jsx("div",{dangerouslySetInnerHTML:{__html:C}})]})}export{P as default};
