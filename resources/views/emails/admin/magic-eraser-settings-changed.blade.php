...
<head>
    ...
    <style>
        ...
        .header { background: #7c3aed; color: #fff; padding: 32px 28px; text-align: center; }
        .header h1 { margin: 0; font-size: 24px; font-weight: 700; }
        .header p { margin: 8px 0 0; font-size: 14px; opacity: 0.9; }
        .content { padding: 30px 28px; }
        .badge { display: inline-block; background: rgba(124, 58, 237, 0.12); color: #5b21b6; border: 1px solid rgba(124, 58, 237, 0.3); font-size: 13px; font-weight: 700; padding: 6px 14px; border-radius: 20px; margin-bottom: 16px; letter-spacing: 0.2px; }
        .meta { background-color: rgba(124, 58, 237, 0.06); border: 1px solid rgba(124, 58, 237, 0.15); border-radius: 8px; padding: 14px 16px; margin-bottom: 18px; }
