...
<head>
    ...
    <style>
        ...
        .badge { display: inline-block; background: rgba(70, 138, 154, 0.12); color: #1f5f6e; border: 1px solid rgba(70, 138, 154, 0.3); font-size: 13px; font-weight: 700; padding: 6px 14px; border-radius: 20px; margin-bottom: 16px; letter-spacing: 0.2px; }
