...
<head>
    ...
    <style>
        ...
        .success-badge { display: inline-block; background-color: rgba(34, 197, 94, 0.1); border: 1px solid rgba(34, 197, 94, 0.25); color: #15803d; font-size: 14px; font-weight: 700; padding: 10px 24px; border-radius: 8px; margin: 4px 0 20px; }
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div style="text-align: center; margin-bottom: 8px;">
                <span class="success-badge">✓ &nbsp;Two-Factor Authentication Enabled</span>
            </div>

            <p class="greeting">Hello <strong>{{ $user->name }}</strong>,</p>

            <p>Two-factor authentication has been successfully enabled on your admin account. Your account is now protected with an additional layer of security.</p>
            ...
            <p style="font-size: 14px; color: #374151;">From now on, you will need to enter a 6-digit code from your authenticator app each time you log in.</p>

            <div class="notice">
                <p>If you did not make this change, your account may be compromised. Please <strong>change your password immediately</strong> and contact your system administrator.</p>
            </div>
